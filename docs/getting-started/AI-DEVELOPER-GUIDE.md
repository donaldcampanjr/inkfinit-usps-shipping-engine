...
- ❓ Should international shipping be First Class International or Priority Mail International?
- ❓ Do we need DHL/FedEx/UPS or USPS-only?

### 2. BOX PACKING

- ❓ Should we auto-select boxes or let merchant choose?
- ❓ Do we handle multi-package orders (weight > 70 lbs)?
- ❓ Should we consider dimensional weight pricing?
- ❓ Do we auto-pack items or just display recommendation?
